...
Rect2D::operator&=( const Rect2D & other )
{
    ...
    double l = std::fmax( this->left(), other.left() );
    double t = std::fmax( this->top(), other.top() );
    double w = std::fmin( this->right(), other.right() ) - l;
    double h = std::fmin( this->bottom(), other.bottom() ) - t;
...
Rect2D::operator|=( const Rect2D & other )
{
    ...
    double l = std::fmin( this->left(), other.left() );
    double t = std::fmin( this->top(), other.top() );
    double w = std::fmax( this->right(), other.right() ) - l;
    double h = std::fmax( this->bottom(), other.bottom() ) - t;
